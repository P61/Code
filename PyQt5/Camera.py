...
from  PyQt5.QtMultimediaWidgets import  QCamera,QCameraImageCapture,QCameraViewfinderSettings
import CameraWin
...
class CameraMainWin(QtWidgets.QMainWindow,CameraWin.Ui_CameraWin):
    def __init__(self):
        ...
        self.catchButton.clicked.connect(self.takePic)
        self.openButton.clicked.connect(self.switchCamera)
